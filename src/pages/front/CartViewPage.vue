            ...
            <q-item clickable class="text-center q-my-xl" style="background: #fff;" v-for="(product, idx) in cart" :key="product._id" :class="{'bg-red': !product.p_id.sell}">
              <!-- <q-item-section> -->
                <!-- <img :src="product.p_id.image" :aspect-ratio="1" :width="150" :height="150"
                  ...
                  <router-link class="col-12 col-sm-2 row justify-center items-center" :to="'/products/' + _id">
              ...
              <q-item-section class="col-12 col-sm-2 row justify-center items-center">{{ product.p_id.date }}</q-item-section>
              <q-item-section class="col-12 col-sm-2 row justify-center items-center">{{ product.p_id.price }} 元</q-item-section>
              <!-- <q-item-section>
                <div class="count">
